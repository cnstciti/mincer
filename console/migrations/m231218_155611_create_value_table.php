 ...
 */
class m231218_155611_create_value_table extends Migration
{
    protected const TABLE_NAME = '{{%value}}';
    ...
    public function safeUp()
    {
        ...
        if ($this->db->driverName === 'mysql') {
            ...
            $tableOptions = "CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE=InnoDB COMMENT='Значения'";
        }
