...
/**
 * Class m241006_204753_create_v_set_type_data_view
 */
class m241006_204753_create_v_set_type_data_view extends Migration
{
    /**
     * {@inheritdoc}
     */
...
left join (
    ...
    left join  `dictionary_content` `dc` on
        ((`vs`.`dictionaryContentId` = `dc`.`id`)))) `uv` on
    ((`v`.`id` = `uv`.`id`)))
where
    (`tv`.`name` = 'set')
QUERY;
