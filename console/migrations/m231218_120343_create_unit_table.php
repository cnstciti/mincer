 ...
 */
class m231218_120343_create_unit_table extends Migration
{
    protected const TABLE_NAME = '{{%unit}}';
    ...
    public function safeUp()
    {
        ...
        $this->createTable(
            ...
            'shortName'  => $this->string(128)->notNull()->comment('_Короткое наименование_'),
