...
class TypeValueService
{
     ...
     * @throws Exception
     */
    public static function getForm(TypeValueForm $form, int $typeValueId = 0): TypeValueForm
    {
     ...
     * @return string
     */
    public static function getName(int $typeValueId): string
    {
        return TypeValueTable::findOne($typeValueId)->name;
    }
