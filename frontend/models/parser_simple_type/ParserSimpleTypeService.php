...
class ParserSimpleTypeService
{
    ...
    {
        $searchModel = new ParserSimpleTypeSearch();
        
        return ParserSimpleTypeGrid::get(
            $searchModel,
    ...
    /*
    public function getLinkEnumForm(int $attributeId = 0): LinkEnumForm
    {
        $model = $attributeId
